  ...
  <body class="p-3 m-0 border-0">
    ...
    <section class="container mt-4">
      ...
      <div class="card shadow">
        ...
        <div class="card-body">
          <!-- Form Edit -->
          <form action="{{ route('surat.update', $ahliwaris->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <label for="bukti_register">Bukti Register (Foto):</label>
            <input type="file" name="bukti_register" class="form-control mb-2">
